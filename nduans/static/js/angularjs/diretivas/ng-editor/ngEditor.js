    ...
    return {
      ...
      link: function($scope, element, attributes){
        ...
        var fonts = {
          ...
          'Microsoft elegante negro':'Microsoft YaHei',
          'cursiva': 'SimKai',
          'cuerpo negro':'SimHei',
          'lishu':'SimLi',
        ...
        $scope.command = function (cmd, b, val, event) {
          ...
          switch (cmd) {
            case 'createLink':
              val = prompt('Por favor, introduzca la URL del enlace');
              if (!val) return;
              break;
            case 'insertImage':
              val = prompt('Por favor, introduzca la URL de la imagen');
              if (!val) return;
              break;
            case 'localImage':
